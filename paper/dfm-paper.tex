...
% =====================================================================
\documentclass[aps,reprint,amsmath,amssymb,nofootinbib,superscriptaddress]{revtex4-2}
...
% TODO(author): affiliation line to be confirmed before submission.
...
have been made and criticized as orders of magnitude too
small~\cite{CooperstockTieu2005,Ludwig2021}; DFM does not enter that
controversy, because it makes $k_F$ a free dial and studies the
counterfactual.
...
Mercury~\cite{Iorio2011}), but the radial power differs
...
CC~BY~4.0.
% TODO(submission): insert repository URL / Zenodo DOI here.
...
% =====================================================================
% Bibliography.  TODO(submission): verify every entry against the
% original source before submission (per THEORY_SYNTHESIS Sec. 5).
\begin{thebibliography}{99}

\bibitem{Newton1687}
I.~Newton, \emph{Philosophi\ae{} Naturalis Principia Mathematica}
(London, 1687), Scholium to the Definitions.

\bibitem{Mach1883}
E.~Mach, \emph{Die Mechanik in ihrer Entwickelung} (Brockhaus,
Leipzig, 1883); English translation: \emph{The Science of Mechanics}
(Open Court, 1893).
...
dynamical theories,''
Proc.\ R.\ Soc.\ London A \textbf{382}, 295--306 (1982).

\bibitem{LenseThirring1918}
J.~Lense and H.~Thirring, ``\"Uber den Einfluss der Eigenrotation der
Zentralk\"orper auf die Bewegung der Planeten und Monde nach der
...
\bibitem{Iorio2011}
L.~Iorio, ``Perturbed stellar motion around the rotating black hole in
Sgr A* for a generic orientation of its spin axis,''
Phys.\ Rev.\ D \textbf{84}, 124001 (2011).
% TODO(submission): replace with the specific Iorio reference for the
% solar Lense--Thirring perihelion precession of Mercury (-2 mas/cy).
